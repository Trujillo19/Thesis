...
%Insertar aquí lista de parámetros
...
Con los datos del cuadro \ref{table:dynamics} se selecciona los torques máximos en el escenario más demandante, este es cuando el brazo se encuentra completamente extendido a lo largo del plano X-Y.
